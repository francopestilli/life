function s_ms_afq_test_fascicle_JW
%
...
% connectomeFile       = {'run01_fliprot_aligned_trilin_dwi_run01_fliprot_aligned_trilin_brainmask_run01_fliprot_aligned_trilin_wm_tensor-500000.pdb', ...
%                         'run01_fliprot_aligned_trilin_csd_lmax8_run01_fliprot_aligned_trilin_brainmask_run01_fliprot_aligned_trilin_wm_prob-500000.pdb'};%, ...
...
connectomeFile       = {'0005_01_DTI_2mm_150dir_2x_b2000_aligned_trilin_csd_lmax8_0005_01_DTI_2mm_150dir_2x_b2000_aligned_trilin_brainmask_0005_01_DTI_2mm_150dir_2x_b2000_aligned_trilin_wm_prob-500000.pdb',...
                        ... '0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_csd_lmax12_0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_brainmask_0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_wm_prob-500000.pdb', ...
                        ... '0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_csd_lmax2_0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_brainmask_0009_01_DWI_2mm150dir_2x_b1000_aligned_trilin_wm_prob-500000.pdb'};
...
% FASCICLES:
fascicleNames   = {'rSlf', 'lSlf'};
fascicleIndices = {16,15};

% Handling parallel processing
poolwasopen=1; % if a matlabpool was open already we do not open nor close one
if (matlabpool('size') == 0), matlabpool open; poolwasopen=0; end

for ifas = 1:2% Right and left arcuate
for irep = 1:length(connectSubfolders)
  for ii = 1:length(connectomeFile)
    ...
    if ~isdir(fasSaveDir),mkdir(fasSaveDir);end
    roiSaveDir    = fullfile(saveDir,connectSubfolders{irep},roi_saveDir);
    if ~isdir(roiSaveDir),mkdir(roiSaveDir);end
...
%       clear classificationCleaned fg arcuateIndxIntoFG
%       
%       % Clip the corticospinal tract to be constrained inside the volume defined
%       % by the arcuate.
%       tic, fprintf('[%s] Clipping Connectome fibers fibers volume ROI of the arcuate... ',mfilename);
