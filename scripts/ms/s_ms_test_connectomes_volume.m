function s_ms_test_connectomes_volume(trackingType,dataType,lmax,diffusionModelParams,recompute)
%
...
for i_lmax = 1:length(lmax)
  switch dataType
    case {'150dirs','2mm'}
      ...
      plots_saveDir     = fullfile('/home/frk/Dropbox','connectomes_volume_150dirs');
