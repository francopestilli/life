...
if recompute_fe
  ...
  feFileName = '20120830T160637-right_hemisphere_occipital_MRTRIX_FE.mat';
...
rmse_w_map = feValues2volume(rmse_with_or,unique(OR_roi.coords,'rows'),sz(1:3));
...
rmse_wo_map = feValues2volume(rmse_without_or,unique(OR_roi.coords,'rows'),sz(1:3));
