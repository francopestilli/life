...
if notDefined('dtiDataType'); dtiDataType = 'b2000';end
...
if reTrackFibers
    numFibersPerCoord = 1;
    fg3 = mctTrackInRoi(dt,roi,numFibersPerCoord, fgName,3);
    fg3.seeds = [];
    
    numFibersPerCoord = 1;
    fg1 = mctTrackInRoi(dt,roi,numFibersPerCoord, fgName,1);
    fg1.seeds = [];
    
    fg = fgMerge(fg1,fg3,'combined');
