function fe_mpi_fiber
% fe_mpi_fiber
%
% Script that helps visualizing a fiber during tractography.
% THe signal is represented in 2D and 3D.
%
% Franco
...
% fefgGet(fg,'tangent')  - Returns the tangent at each position for each
% fiber
