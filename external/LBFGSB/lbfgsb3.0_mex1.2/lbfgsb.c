...
/* Stephen Becker adding this for the machine epsilon: */
#include <float.h>

/* Stephen Becker adding this for the timer */
#define USE_TIMER 
...
/* The fortran file calls dscal, dcopy, ddot, daxpy.
 * If we want to use Matlab's 32-bit versions, we must rename these.
 * Use this option when you use -lmwblascompat32 (instead of -lmwblas)
 * Actually, this doesn't help, since these routines are called from
 * fortran, not from this file. However, if you use the f2c version
 * and the C files, this might help
 * */
#if defined(_BLAS32_)
  ...
  extern double ddot(const int *n32, const double *dx, const int *incx32,
        const double *dy, const int *incy32);
  extern void dcopy(const int *n32, const double *dx, const int *incx32,
        double *dy, const int *incy32);
  extern void dscal(const int *n32, const double *da, double *dx, const int *incx32);
  extern void daxpy(const int *n32, const double *da, const double *dx,
        const int *incx32, double *dy, const int *incy32);
  #define blas_h
#else
  /* add underscores for Windows */
...
#endif
/* Stephen: some BLAS expects larger ints for the integer variables
 * So, replacing all the "integer" variables with int_F variables,
 * which can be defined as either integer or as ptrdiff_t
 * */
/* #ifdef _BLAS64_ */
#if defined(_BLAS64_)
 #include <stddef.h>
 typedef ptrdiff_t int_F;
  ...
  /* #include "blas.h" */
  #define blas_h
  extern void   dscal(ptrdiff_t *n, double *da, double *dx, ptrdiff_t *incx);
  extern void   dcopy(ptrdiff_t *n, double *dx, ptrdiff_t *incx, double *dy, ptrdiff_t *incy);
  extern double ddot( ptrdiff_t *n, double *dx, ptrdiff_t *incx, double *dy, ptrdiff_t *incy);
  extern void   daxpy(ptrdiff_t *n, double *da, double *dx, ptrdiff_t *incx, double *dy, ptrdiff_t *incy);
#else
...
/* ============================================================================= */
/* Subroutine */ int setulb_(int_F *n, int_F *m, doublereal *x, 
	doublereal *l, doublereal *u, int_F *nbd, doublereal *f, doublereal 
	*g, doublereal *factr, doublereal *pgtol, doublereal *wa, int_F *
	iwa, char *task, int_F *iprint, char *csave, logical *lsave, 
	int_F *isave, doublereal *dsave, ftnlen task_len, ftnlen csave_len)
{
    /* System generated locals */
    int_F i__1;

    /* Builtin functions */
    int_F s_cmp(char *, char *, ftnlen, ftnlen);

    /* Local variables */
    static int_F ld, lr, lt, lz, lwa, lwn, lss, lxp, lws, lwt, lsy, lwy, 
	    lsnd;
    extern /* Subroutine */ int mainlb_(int_F *, int_F *, doublereal *, 
	    doublereal *, doublereal *, int_F *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, int_F *, int_F *, 
	    int_F *, char *, int_F *, char *, logical *, int_F *, 
...
/*     n is an int_F variable. */
/*       On entry n is the dimension of the problem. */
/*       On exit n is unchanged. */

/*     m is an int_F variable. */
...
/*     nbd is an int_F array of dimension n. */
...
/*     iwa is an int_F working array of length 3nmax. */

/*     task is a working string of characters of length 60 indicating */
/*       the current job when entering and quitting this subroutine. */

/*     iprint is an int_F variable that must be set by the user. */
...
/*     isave is an int_F working array of dimension 44. */
/*       On exit with 'task' = NEW_X, the following information is */
/*                                                             available: */
...
/* ======================= The end of setulb ============================= */
/* Subroutine */ int mainlb_(int_F *n, int_F *m, doublereal *x, 
	doublereal *l, doublereal *u, int_F *nbd, doublereal *f, doublereal 
	*g, doublereal *factr, doublereal *pgtol, doublereal *ws, doublereal *
	...
	doublereal *t, doublereal *xp, doublereal *wa, int_F *index, 
	int_F *iwhere, int_F *indx2, char *task, int_F *iprint, char *
	csave, logical *lsave, int_F *isave, doublereal *dsave, ftnlen 
	task_len, ftnlen csave_len)
{
    ...
    /* System generated locals */
    int_F ws_dim1, ws_offset, wy_dim1, wy_offset, sy_dim1, sy_offset, 
    ...
    int_F f_open(olist *), s_wsfe(cilist *), do_fio(int_F *, char *, 
	    ftnlen), e_wsfe(void);
    ...
    extern doublereal ddot(int_F *, doublereal *, int_F *, doublereal *, 
	    int_F *);
#endif
    static int_F info, nseg;
    static doublereal time;
    static int_F nfgv, ifun, iter;
    static char word[3];
    static doublereal time1, time2;
    static int_F iback;
#ifndef blas_h
    extern /* Subroutine */ int dscal(int_F *, doublereal *, doublereal *, 
	    int_F *);
#endif
    ...
    /*extern int freev_(int_F *, int_F *, int_F *, 
	    int_F *, int_F *, int_F *, int_F *, logical *, logical *, 
	    logical *, int_F *, int_F *), dcopy(int_F *, doublereal *, 
	    int_F *, doublereal *, int_F *);*/
    extern /* Subroutine */ int freev_(int_F *, int_F *, int_F *, 
	    int_F *, int_F *, int_F *, int_F *, logical *, logical *, 
	    logical *, int_F *, int_F *);
#ifndef blas_h
    extern /* Subroutine */ int dcopy(int_F *, doublereal *, 
	    int_F *, doublereal *, int_F *);
#endif
    static doublereal dnorm;
#ifdef USE_TIMER
    extern int timer(doublereal *), formk_(int_F *, 
	    int_F *, int_F *, int_F *, int_F *, int_F *, int_F *, 
	    logical *, doublereal *, doublereal *, int_F *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, int_F *, int_F *, 
	    int_F *);
#endif
    static int_F nskip, iword;
    extern /* Subroutine */ int formt_(int_F *, doublereal *, doublereal *, 
	    doublereal *, int_F *, doublereal *, int_F *), subsm_(int_F 
	    *, int_F *, int_F *, int_F *, doublereal *, doublereal *, 
	    int_F *, doublereal *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, int_F *
	    , int_F *, int_F *, doublereal *, doublereal *, int_F *, 
	    int_F *);
    static doublereal xstep, stpmx;
    extern /* Subroutine */ int prn1lb_(int_F *, int_F *, doublereal *, 
	    doublereal *, doublereal *, int_F *, int_F *, doublereal *), 
	    prn2lb_(int_F *, doublereal *, doublereal *, doublereal *, 
	    int_F *, int_F *, int_F *, int_F *, int_F *, doublereal 
	    *, int_F *, char *, int_F *, int_F *, doublereal *, 
	    doublereal *, ftnlen), prn3lb_(int_F *, doublereal *, 
	    doublereal *, char *, int_F *, int_F *, int_F *, int_F *, 
	    int_F *, int_F *, int_F *, int_F *, doublereal *, 
	    doublereal *, int_F *, char *, int_F *, doublereal *, 
	    doublereal *, int_F *, doublereal *, doublereal *, doublereal *,
	     ftnlen, ftnlen);
    static int_F ileave;
    extern /* Subroutine */ int errclb_(int_F *, int_F *, doublereal *, 
	    doublereal *, doublereal *, int_F *, char *, int_F *, int_F 
	    *, ftnlen);
    static doublereal cachyt;
    static int_F itfile;
    extern /* Subroutine */ int active_(int_F *, doublereal *, doublereal *,
	     int_F *, doublereal *, int_F *, int_F *, logical *, 
	    logical *, logical *), cauchy_(int_F *, doublereal *, 
	    doublereal *, doublereal *, int_F *, doublereal *, int_F *, 
	    int_F *, doublereal *, doublereal *, doublereal *, int_F *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, int_F *, int_F *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, int_F *, int_F *, doublereal *, 
	    int_F *, doublereal *);
    static doublereal epsmch;
    extern /* Subroutine */ int cmprlb_(int_F *, int_F *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, int_F *,
	     doublereal *, int_F *, int_F *, int_F *, logical *, 
	    int_F *);
    ...
    extern /* Subroutine */ int matupd_(int_F *, int_F *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, int_F *, int_F *, int_F *, int_F *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *);
    static int_F nenter;
    static doublereal lnscht;
    extern /* Subroutine */ int lnsrlb_(int_F *, doublereal *, doublereal *,
	     int_F *, doublereal *, doublereal *, doublereal *, doublereal *
	    , doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, int_F *, int_F *, 
	    int_F *, int_F *, int_F *, char *, logical *, logical *, 
	    char *, int_F *, doublereal *, ftnlen, ftnlen);
    static int_F nintol;
    extern /* Subroutine */ int projgr_(int_F *, doublereal *, doublereal *,
	     int_F *, doublereal *, doublereal *, doublereal *);
...
/*     index is an int_F working array of dimension n. */
/*       In subroutine freev, index is used to store the free and fixed */
/*          variables at the Generalized Cauchy Point (GCP). */

/*     iwhere is an int_F working array of dimension n used to record */
...
/*     indx2 is an int_F working array of dimension n. */
...
/*     isave is an int_F working array of dimension 23. */
...
/*     ************ */
    ...
    if (s_cmp(task, "START", (ftnlen)60, (ftnlen)5) == 0) {
/*        epsmch = epsilon(one) */
/*       Stephen changing this, just for the f2c conversion. Must */
/*        edit C file by hand, and use DBL_EPSILON from float.h */
/* 	epsmch = 1.f; */
    epsmch = DBL_EPSILON;
#ifdef USE_TIMER
	timer(&time1); 
...
/*     Compute the infinity norm of the (-) projected gradient. */
    ...
    if (*iprint >= 1) {
	s_wsfe(&io___55);
	do_fio(&c__1, (char *)&iter, (ftnlen)sizeof(int_F));
	...
	s_wsfe(&io___56);
	do_fio(&c__1, (char *)&iter, (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&nfgv, (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&sbgnrm, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&(*f), (ftnlen)sizeof(doublereal));
	e_wsfe();
    }
...
L222:
	...
	s_wsfe(&io___57);
	i__1 = iter + 1;
	do_fio(&c__1, (char *)&i__1, (ftnlen)sizeof(int_F));
	e_wsfe();
    }
    iword = -1;
...
/* ======================= The end of mainlb ============================= */
/* Subroutine */ int active_(int_F *n, doublereal *l, doublereal *u, 
	int_F *nbd, doublereal *x, int_F *iwhere, int_F *iprint, 
	logical *prjctd, logical *cnstnd, logical *boxed)
{
    ...
    /* Builtin functions */
    int_F s_wsle(cilist *), do_lio(int_F *, int_F *, char *, ftnlen), 
	    e_wsle(void), s_wsfe(cilist *), do_fio(int_F *, char *, ftnlen),
	     e_wsfe(void);

    /* Local variables */
    static int_F i__, nbdd;
...
/*     iwhere is an int_F array of dimension n. */
...
/* L20: */
    ...
    if (*iprint > 0) {
	s_wsfe(&io___76);
	do_fio(&c__1, (char *)&nbdd, (ftnlen)sizeof(int_F));
	e_wsfe();
    }
    return 0;
} /* active_ */
...
/* ======================= The end of active ============================= */
/* Subroutine */ int bmv_(int_F *m, doublereal *sy, doublereal *wt, int_F 
	*col, doublereal *v, doublereal *p, int_F *info)
{
    /* System generated locals */
    int_F sy_dim1, sy_offset, wt_dim1, wt_offset, i__1, i__2;

    /* Builtin functions */
    double sqrt(doublereal);

    /* Local variables */
    static int_F i__, k, i2;
    static doublereal sum;
    extern /* Subroutine */ int dtrsl_(doublereal *, int_F *, int_F *, 
	    doublereal *, int_F *, int_F *);
...
/* ======================== The end of bmv =============================== */
/* Subroutine */ int cauchy_(int_F *n, doublereal *x, doublereal *l, 
	doublereal *u, int_F *nbd, doublereal *g, int_F *iorder, int_F *
	iwhere, doublereal *t, doublereal *d__, doublereal *xcp, int_F *m, 
	doublereal *wy, doublereal *ws, doublereal *sy, doublereal *wt, 
	doublereal *theta, int_F *col, int_F *head, doublereal *p, 
	doublereal *c__, doublereal *wbp, doublereal *v, int_F *nseg, 
	int_F *iprint, doublereal *sbgnrm, int_F *info, doublereal *
	epsmch)
{
    /* Format strings */
    ...
    /* System generated locals */
    int_F wy_dim1, wy_offset, ws_dim1, ws_offset, sy_dim1, sy_offset, 
	    wt_dim1, wt_offset, i__1, i__2;
    doublereal d__1;

    /* Builtin functions */
    int_F s_wsle(cilist *), do_lio(int_F *, int_F *, char *, ftnlen), 
	    e_wsle(void), s_wsfe(cilist *), e_wsfe(void), do_fio(int_F *, 
	    char *, ftnlen);
    ...
    extern /* Subroutine */ int bmv_(int_F *, doublereal *, doublereal *, 
	    int_F *, doublereal *, doublereal *, int_F *);
    ...
    static int_F nleft;
#ifndef blas_h
    extern /* Subroutine */ int dcopy(int_F *, doublereal *, int_F *, 
	    doublereal *, int_F *), daxpy(int_F *, doublereal *, 
	    doublereal *, int_F *, doublereal *, int_F *);
#endif
    static doublereal f2_org__;
    static int_F nbreak, ibkmin;
    extern /* Subroutine */ int hpsolb_(int_F *, doublereal *, int_F *, 
	    int_F *);
    static int_F pointr;
...
/*     iorder is an int_F working array of dimension n. */
...
/*     Initialize derivative f2. */
    ...
    *nseg = 1;
	...
	do_lio(&c__3, &c__1, (char *)&nbreak, (ftnlen)sizeof(int_F));
...
/*           (if iter=2, initialize heap). */
    ...
    if (dt != 0. && *iprint >= 100) {
	s_wsfe(&io___110);
	do_fio(&c__1, (char *)&(*nseg), (ftnlen)sizeof(int_F));
...
/*       reset the corresponding component of d to zero. */
	...
	do_lio(&c__3, &c__1, (char *)&ibp, (ftnlen)sizeof(int_F));
...
/* ====================== The end of cauchy ============================== */
/* Subroutine */ int cmprlb_(int_F *n, int_F *m, doublereal *x, 
	doublereal *g, doublereal *ws, doublereal *wy, doublereal *sy, 
	doublereal *wt, doublereal *z__, doublereal *r__, doublereal *wa, 
	int_F *index, doublereal *theta, int_F *col, int_F *head, 
	int_F *nfree, logical *cnstnd, int_F *info)
{
    /* System generated locals */
    int_F ws_dim1, ws_offset, wy_dim1, wy_offset, sy_dim1, sy_offset, 
	    wt_dim1, wt_offset, i__1, i__2;
...
/* ======================= The end of cmprlb ============================= */
/* Subroutine */ int errclb_(int_F *n, int_F *m, doublereal *factr, 
	doublereal *l, doublereal *u, int_F *nbd, char *task, int_F *info,
	 int_F *k, ftnlen task_len)
{
    /* System generated locals */
    int_F i__1;
...
/* ======================= The end of errclb ============================= */
/* Subroutine */ int formk_(int_F *n, int_F *nsub, int_F *ind, int_F *
	nenter, int_F *ileave, int_F *indx2, int_F *iupdat, logical *
	updatd, doublereal *wn, doublereal *wn1, int_F *m, doublereal *ws, 
	doublereal *wy, doublereal *sy, doublereal *theta, int_F *col, 
	int_F *head, int_F *info)
{
    /* System generated locals */
    int_F wn_dim1, wn_offset, wn1_dim1, wn1_offset, ws_dim1, ws_offset, 
	    wy_dim1, wy_offset, sy_dim1, sy_offset, i__1, i__2, i__3;

    /* Local variables */
    static int_F i__, k, k1, m2, is, js, iy, jy, is1, js1, col2, dend, pend;
#ifndef blas_h
    extern doublereal ddot(int_F *, doublereal *, int_F *, doublereal *, 
	    int_F *);
#endif
    ...
    extern /* Subroutine */ int dpofa_(doublereal *, int_F *, int_F *, 
	    int_F *);
#ifndef blas_h
    extern /* Subroutine */ int dcopy(int_F *, doublereal *, int_F *, doublereal 
	    *, int_F *);
#endif
    extern /* Subroutine */ int dtrsl_(doublereal *, int_F *, int_F *, 
	    doublereal *, int_F *, int_F *);
    static int_F ipntr, jpntr, dbegin, pbegin;
...
/*     nsub is an int_F variable */
/*       On entry nsub is the number of subspace variables in free set. */
/*       On exit nsub is not changed. */

/*     ind is an int_F array of dimension nsub. */
/*       On entry ind specifies the indices of subspace variables. */
/*       On exit ind is unchanged. */

/*     nenter is an int_F variable. */
/*       On entry nenter is the number of variables entering the */
/*         free set. */
/*       On exit nenter is unchanged. */

/*     ileave is an int_F variable. */
/*       On entry indx2(ileave),...,indx2(n) are the variables leaving */
/*         the free set. */
/*       On exit ileave is unchanged. */

/*     indx2 is an int_F array of dimension n. */
/*       On entry indx2(1),...,indx2(nenter) are the variables entering */
/*         the free set, while indx2(ileave),...,indx2(n) are the */
/*         variables leaving the free set. */
/*       On exit indx2 is unchanged. */

/*     iupdat is an int_F variable. */
...
/* ======================= The end of formk ============================== */
/* Subroutine */ int formt_(int_F *m, doublereal *wt, doublereal *sy, 
	doublereal *ss, int_F *col, doublereal *theta, int_F *info)
{
    /* System generated locals */
    int_F wt_dim1, wt_offset, sy_dim1, sy_offset, ss_dim1, ss_offset, i__1, 
	    i__2, i__3;

    /* Local variables */
    static int_F i__, j, k, k1;
    static doublereal ddum;
    extern /* Subroutine */ int dpofa_(doublereal *, int_F *, int_F *, 
	    int_F *);
...
/* ======================= The end of formt ============================== */
/* Subroutine */ int freev_(int_F *n, int_F *nfree, int_F *index, 
	int_F *nenter, int_F *ileave, int_F *indx2, int_F *iwhere, 
	logical *wrk, logical *updatd, logical *cnstnd, int_F *iprint, 
	int_F *iter)
{
    /* System generated locals */
    int_F i__1;
...
/*     index is an int_F array of dimension n */
...
/*            write(6,*) ' index = ', i */
		...
		if (*iprint >= 100) {
		    ...
		    do_lio(&c__3, &c__1, (char *)&k, (ftnlen)sizeof(int_F));
...
/* L22: */
	...
	if (*iprint >= 99) {
	    s_wsle(&io___164);
	    i__1 = *n + 1 - *ileave;
	    do_lio(&c__3, &c__1, (char *)&i__1, (ftnlen)sizeof(int_F));
	    do_lio(&c__9, &c__1, " variables leave; ", (ftnlen)18);
	    do_lio(&c__3, &c__1, (char *)&(*nenter), (ftnlen)sizeof(int_F));
...
/* L24: */
    ...
    if (*iprint >= 99) {
	s_wsle(&io___166);
	do_lio(&c__3, &c__1, (char *)&(*nfree), (ftnlen)sizeof(int_F));
...
/* ======================= The end of freev ============================== */
/* Subroutine */ int hpsolb_(int_F *n, doublereal *t, int_F *iorder, 
	int_F *iheap)
{
    /* System generated locals */
    int_F i__1;
...
/*     iorder is an int_F array of dimension n. */
/*       On entry iorder(i) is the index of t(i). */
/*       On exit iorder(i) is still the index of t(i), but iorder may be */
/*         permuted in accordance with t. */

/*     iheap is an int_F variable specifying the task. */
...
/* ====================== The end of hpsolb ============================== */
/* Subroutine */ int lnsrlb_(int_F *n, doublereal *l, doublereal *u, 
	int_F *nbd, doublereal *x, doublereal *f, doublereal *fold, 
	...
	stpmx, int_F *iter, int_F *ifun, int_F *iback, int_F *nfgv, 
	int_F *info, char *task, logical *boxed, logical *cnstnd, char *
	csave, int_F *isave, doublereal *dsave, ftnlen task_len, ftnlen 
	csave_len)
{
    /* System generated locals */
    int_F i__1;
    ...
    extern /* Subroutine */ int dcopy(int_F *, doublereal *, int_F *, 
	    doublereal *, int_F *);
#endif
    extern /* Subroutinen */ int dcsrch_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, char *, int_F *, doublereal *, 
	    ftnlen);
...
/* ======================= The end of lnsrlb ============================= */
/* Subroutine */ int matupd_(int_F *n, int_F *m, doublereal *ws, 
	doublereal *wy, doublereal *sy, doublereal *ss, doublereal *d__, 
	doublereal *r__, int_F *itail, int_F *iupdat, int_F *col, 
	int_F *head, doublereal *theta, doublereal *rr, doublereal *dr, 
...
/* ======================= The end of matupd ============================= */
/* Subroutine */ int prn1lb_(int_F *n, int_F *m, doublereal *l, 
	doublereal *u, doublereal *x, int_F *iprint, int_F *itfile, 
	doublereal *epsmch)
{
    /* Format strings */
    ...
    /* Builtin functions */
    int_F s_wsfe(cilist *), do_fio(int_F *, char *, ftnlen), e_wsfe(void),
	     s_wsle(cilist *), do_lio(int_F *, int_F *, char *, ftnlen), 
	    e_wsle(void);
...
/*     ************ */
	...
	do_lio(&c__3, &c__1, (char *)&(*n), (ftnlen)sizeof(int_F));
	do_lio(&c__9, &c__1, "    M = ", (ftnlen)8);
	do_lio(&c__3, &c__1, (char *)&(*m), (ftnlen)sizeof(int_F));
	e_wsle();
	if (*iprint >= 1) {
...
/* ======================= The end of prn1lb ============================= */
/* Subroutine */ int prn2lb_(int_F *n, doublereal *x, doublereal *f, 
	doublereal *g, int_F *iprint, int_F *itfile, int_F *iter, 
	int_F *nfgv, int_F *nact, doublereal *sbgnrm, int_F *nseg, char 
	*word, int_F *iword, int_F *iback, doublereal *stp, doublereal *
...
/*                             the truncated Newton step has been used. */
	...
	do_lio(&c__3, &c__1, (char *)&(*iback), (ftnlen)sizeof(int_F));
	...
	do_fio(&c__1, (char *)&(*nfgv), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nseg), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nact), (ftnlen)sizeof(int_F));
	do_fio(&c__1, word, (ftnlen)3);
	do_fio(&c__1, (char *)&(*iback), (ftnlen)sizeof(int_F));
...
/* ======================= The end of prn2lb ============================= */
/* Subroutine */ int prn3lb_(int_F *n, doublereal *x, doublereal *f, char *
	task, int_F *iprint, int_F *info, int_F *itfile, int_F *iter, 
	int_F *nfgv, int_F *nintol, int_F *nskip, int_F *nact, 
	doublereal *sbgnrm, doublereal *time, int_F *nseg, char *word, 
	int_F *iback, doublereal *stp, doublereal *xstep, int_F *k, 
	...
	task_len, ftnlen word_len)
{
    ...
    /* Builtin functions */
    int_F s_cmp(char *, char *, ftnlen, ftnlen), s_wsfe(cilist *), e_wsfe(
	    void), do_fio(int_F *, char *, ftnlen), s_wsle(cilist *), 
	    do_lio(int_F *, int_F *, char *, ftnlen), e_wsle(void);
...
/*     ************ */
	...
	e_wsfe();
	s_wsfe(&io___199);
	do_fio(&c__1, (char *)&(*n), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*iter), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nfgv), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nintol), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nskip), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*nact), (ftnlen)sizeof(int_F));
	do_fio(&c__1, (char *)&(*sbgnrm), (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&(*f), (ftnlen)sizeof(doublereal));
	e_wsfe();
...
/* ======================= The end of prn3lb ============================= */
/* Subroutine */ int projgr_(int_F *n, doublereal *l, doublereal *u, 
	int_F *nbd, doublereal *x, doublereal *g, doublereal *sbgnrm)
{
    /* System generated locals */
    int_F i__1;
    doublereal d__1, d__2;
...
/* ======================= The end of projgr ============================= */
/* Subroutine */ int subsm_(int_F *n, int_F *m, int_F *nsub, int_F *
	ind, doublereal *l, doublereal *u, int_F *nbd, doublereal *x, 
	doublereal *d__, doublereal *xp, doublereal *ws, doublereal *wy, 
	doublereal *theta, doublereal *xx, doublereal *gg, int_F *col, 
	int_F *head, int_F *iword, doublereal *wv, doublereal *wn, 
	int_F *iprint, int_F *info)
{
    /* Format strings */
    ...
    /* System generated locals */
    int_F ws_dim1, ws_offset, wy_dim1, wy_offset, wn_dim1, wn_offset, i__1, 
	    i__2;
    doublereal d__1, d__2;

    /* Builtin functions */
    int_F s_wsfe(cilist *), e_wsfe(void), s_wsle(cilist *), do_lio(int_F *
	    , int_F *, char *, ftnlen), e_wsle(void);

    /* Local variables */
    static int_F i__, j, k, m2;
    static doublereal dk;
    static int_F js, jy;
    static doublereal xk;
    static int_F ibd, col2;
    static doublereal dd_p__, temp1, temp2, alpha;
#ifndef blas_h
    extern /* Subroutine */ int dscal(int_F *, doublereal *, doublereal *, 
	    int_F *), dcopy(int_F *, doublereal *, int_F *, doublereal 
	    *, int_F *);
#endif
	extern /* Soubrouine */ int dtrsl_(doublereal *, int_F *, int_F *, 
	    doublereal *, int_F *, int_F *);
    static int_F pointr;
...
/*     nbd is a int_F array of dimension n. */
/*       On entry nbd represents the type of bounds imposed on the */
/*         variables, and must be specified as follows: */
/*         nbd(i)=0 if x(i) is unbounded, */
/*                1 if x(i) has only a lower bound, */
...
/* Subroutine */ int dcsrch_(doublereal *f, doublereal *g, doublereal *stp, 
	...
	stpmin, doublereal *stpmax, char *task, int_F *isave, doublereal *
...
/*       isave is an int_F work array of dimension 2. */
